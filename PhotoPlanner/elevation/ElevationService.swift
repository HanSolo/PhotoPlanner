...
actor ElevationService {
    ...
    func elevationProfile(from start: CLLocationCoordinate2D, to end: CLLocationCoordinate2D, interval: CLLocationDistance = 100, cameraHeight: Double = 1.7, subjectHeight: Double = 0.0) async throws -> ElevationProfile {
