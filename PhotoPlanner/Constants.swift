...
public class Constants {
    ...
    public static let TWENTY_FOUR_HOUR_FORMAT        : String        = "HH:mm"
    public static let TWELVE_HOUR_FORMAT             : String        = "h:mm a"
    ...
    public static let OUTER_RING_DARK                : GraphicsContext.Shading = GraphicsContext.Shading.color(Color(red: 0.0, green: 0.0, blue: 0.0, opacity: 0.65))
    ...
    public static let TEXT_BRIGHT                    : Color         = Color.black.opacity(0.75)
    ...
    public static let REGULAR_FONT_10                : Font          = Font.system(size: 10, weight: .regular, design: .rounded)
    ...
    public static let STRIKE_GRADIENT_STOPS          : [CGFloat]     = [0.00, 0.05, 0.17, 0.33, 0.46, 0.70, 1.00]
