...
public struct Teleconverter {
    
    var factor    : Double
    var lightLoss : Double { return log2(factor * factor) }
    ...
    func effectiveFocalLength(original: Double) -> Double { return original * factor }
    ...
    func effectiveAperture(original: Double) -> Double { return original * factor }
    ...
    func calculate(focalLength: Double, aperture: Double) -> TcModifiedValues {
        TcModifiedValues(exactFocalLength: effectiveFocalLength(original: focalLength), exactAperture: effectiveAperture(original: aperture),roundedFocalLength: roundedFocalLength(effectiveFocalLength(original: focalLength)), roundedAperture: roundedAperture(effectiveAperture(original: aperture)), lightLoss: lightLoss)
    }
}
